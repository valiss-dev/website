...
{{< hextra/feature-grid >}}
  ...
  {{< hextra/feature-card
    icon="shield-check"
    title="Role in the key material"
...
{{< hextra/feature-grid >}}
  ...
  {{< hextra/feature-card
    icon="clock"
    title="Bearer tokens, scoped narrowly"
...
{{< hextra/feature-grid >}}
  ...
  {{< hextra/feature-card
    ...
    title="Pluggable allowlist sources"
  ...
  {{< hextra/feature-card
    icon="collection"
    title="Multiple trusted operators"
...
{{< hextra/feature-grid >}}
  ...
  {{< hextra/feature-card
    icon="template"
    title="Custom domain extensions"
...
{{< hextra/feature-grid >}}
  ...
  {{< hextra/feature-card
    ...
    title="Replay and tamper binding"
